...
**Self-hosted Playwright scraper for Google Maps — harvest by category, checkpoint to JSONL, enrich emails and phones, export a CSV of only the fields you enable.**
